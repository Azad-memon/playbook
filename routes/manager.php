...
Route::prefix('admin')->as('admin.')->group(function () {
    Route::resource('manager', ManagerController::class)->except(['show']);
     Route::get('company-manager/add-form/{company_id}', [AdminController::class, 'companyManagerAddForm'])
        ->name('company-manager.add-form');

    Route::get('company-manager/edit-form/{id}', [AdminController::class, 'companyManagerEditForm'])
        ->name('company-manager.edit-form');
});
