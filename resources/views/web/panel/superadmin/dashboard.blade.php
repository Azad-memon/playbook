...
@push('custom-scripts')
    <script src="{{ URL::asset('panel/assets/js/clock.js') }}"></script>
    <script src="{{ URL::asset('panel/assets/js/chart/apex-chart/moment.min.js') }}"></script>
    <script src="{{ URL::asset('panel/assets/js/notify/bootstrap-notify.min.js') }}"></script>
    <script src="{{ URL::asset('panel/assets/js/dashboard/default.js') }}"></script>


    <script src="{{ URL::asset('panel/assets/js/height-equal.js') }}"></script>
    <script src="{{ URL::asset('panel/assets/js/animation/wow/wow.min.js') }}"></script>
    <!-- Plugins JS Ends-->
    <script>
        new WOW().init();
                ...
                <div class="card profile-box">
                    <div class="card-body">
                        ...
                        <div class="cartoon"><img class="img-fluid"
                                src="{{ URL::asset('panel/assets/images/dashboard/cartoon.svg') }}"
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round secondary">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#cart') }}">
                                                </use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#halfcircle') }}">
                                                </use>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round primary">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#tag') }}">
                                                    </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use
                                                        href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#halfcircle') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                        </div>
                                ...
                                <div class="widget-content">
                                    <div class="widget-round warning">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use
                                                    href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#return-box') }}">
                                                </use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round success">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#rate') }}">
                                                    </use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use
                                                        href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#income') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use
                                                        href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#expense') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use
                                                        href="{{ URL::asset('panel/assets/svg/icon-sprite.svg#doller-return') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ URL::asset('panel/assets/images/dashboard/user/1.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="user-profile-2.html">Jane Cooper</a><span class="f-light">10
                                                    minutes ago</span></td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ URL::asset('panel/assets/images/dashboard/user/2.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="user-profile-2.html">Brooklyn Simmons</a><span
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ URL::asset('panel/assets/images/dashboard/user/3.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="user-profile-2.html">Leslie Alexander</a><span class="f-light">2
                                                    hours ago</span></td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ URL::asset('panel/assets/images/dashboard/user/4.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="user-profile-2.html">Travis Wright</a><span class="f-light">8
                                                    hours ago</span></td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ URL::asset('panel/assets/images/dashboard/user/5.jpg') }}"
                                                    alt="user"></td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                                    href="user-profile-2.html">Mark Green</a><span class="f-light">1 day
                                                    ago</span></td>
                                            <td class="text-end">
            ...
            <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                <div class="card papernote-wrap">
                    ...
                    <div class="card-body pt-0"> <img class="banner-img img-fluid"
                            src="{{ URL::asset('panel/assets/images/dashboard/papernote.jpg') }}"
                                ...
                                <div class="customers">
                                    <ul>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                ...
                                                alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ URL::asset('panel/assets/images/dashboard/user/6.jpg') }}"
                                                alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ URL::asset('panel/assets/images/dashboard/user/7.jpg') }}"
                                                alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ URL::asset('panel/assets/images/dashboard/user/3.jpg') }}"
                                                alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ URL::asset('panel/assets/images/dashboard/user/8.jpg') }}"
                                                alt="user"></li>
